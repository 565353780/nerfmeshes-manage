...
from data.data_helpers import pose_spherical
...
def export_ply(vertices, diffuse, normals, filename):
    ...
    vertices_s = np.core.records.fromarrays(arr.transpose(),
                                            names=names,
                                            formats=formats)
...
def demo():
    ...
    config_args.config = "./nerfmeshes_manage/Config/ustc_niu.yml"
    config_args.checkpoint = "./logs/nerf-ustc_niu/ustc_niu/version_5/model_last.ckpt"
